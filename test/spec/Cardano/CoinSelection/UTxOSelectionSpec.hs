...
checkCoverage_filter
    :: (Arbitrary u, Show u, Testable prop)
    => (u -> Bool) -> prop -> Property
...
prop_fromNonEmpty_toNonEmpty
    :: UTxOSelectionNonEmpty TestUTxO -> Property
...
prop_availableBalance_availableMap
    :: UTxOSelection TestUTxO -> Property
...
prop_leftoverBalance_selectedBalance
    :: UTxOSelection TestUTxO -> Property
