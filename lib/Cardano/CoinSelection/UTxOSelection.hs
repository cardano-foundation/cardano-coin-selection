...
-}
fromIndexFiltered
    :: (Ord u) => (u -> Bool) -> UTxOIndex u -> UTxOSelection u
fromIndexFiltered f =
...
-}
fromIndexPair
    :: (Ord u) => (UTxOIndex u, UTxOIndex u) -> UTxOSelection u
...
-}
toIndexPair
    :: (IsUTxOSelection s u) => s u -> (UTxOIndex u, UTxOIndex u)
...
-}
toNonEmpty
    :: (IsUTxOSelection s u) => s u -> Maybe (UTxOSelectionNonEmpty u)
...
-}
availableMap
    :: (IsUTxOSelection s u) => (Ord u) => s u -> Map u TokenBundle
