...
-- NOTE: equipartitionAssets, equipartitionQuantities, and
-- equipartitionQuantitiesWithUpperBound have been removed because they
-- depend on equipartitionNatural from Cardano.Numeric.Util and/or
-- TokenQuantity.equipartition, which are not included in this package.
