...
import qualified Cardano.CoinSelection.Types.AssetId as W
    ( AssetId
    )
import qualified Cardano.CoinSelection.Types.TokenBundle as W
    ( TokenBundle
    )
import qualified Cardano.CoinSelection.Types.TokenBundle as W.TokenBundle
import qualified Cardano.CoinSelection.Types.TokenMap as W.TokenMap
